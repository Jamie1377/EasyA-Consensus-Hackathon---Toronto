from stock_prediction_utils import seed_everything
...
# Time Series Models (commented out due to numpy compatibility issues)
try:
    from statsmodels.tsa.statespace.sarimax import SARIMAX
    from statsmodels.tsa.arima.model import ARIMA
    from statsmodels.tsa.holtwinters import ExponentialSmoothing, SimpleExpSmoothing
    # import pmdarima as pm
    # from pmdarima import auto_arima  # Computationally expensive - commented out due to numpy issues
    HAS_ARIMA = True
except ImportError:
    HAS_ARIMA = False

# Alternative of ARIMA or Time Series Models (commented out due to compatibility)
try:
